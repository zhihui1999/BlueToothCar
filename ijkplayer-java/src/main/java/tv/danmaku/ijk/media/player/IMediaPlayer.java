...
public interface IMediaPlayer {
    ...
    void sendRtcpRrData(byte[] data) throws IllegalStateException;

    void takePicture(String path, String fileName, int width, int height, int number)
            throws IOException, IllegalArgumentException, SecurityException, IllegalStateException;

    void startRecordVideo(String path, String fileName, int width, int height)
            throws IOException, IllegalArgumentException, SecurityException, IllegalStateException;
    ...
    interface OnReceivedRtcpSrDataListener {
        void onReceivedRtcpSrData(IMediaPlayer mp, byte[] data);
    }

    interface OnTookPictureListener {
        void onTookPicture(IMediaPlayer mp, int resultCode, String fileName);
    }

    interface OnRecordVideoListener {
        void onRecordVideo(IMediaPlayer mp, int resultCode, String fileName);
    }

    interface OnDeviceConnectedListener {
        void onDeviceConnected(IMediaPlayer mp);
    }
