...
public class MediaPlayerProxy implements IMediaPlayer {
    ...
    @Override
    public void setOnReceivedRtcpSrDataListener(OnReceivedRtcpSrDataListener listener) {
        if (listener != null) {
            final OnReceivedRtcpSrDataListener finalListener = listener;
            mBackEndMediaPlayer.setOnReceivedRtcpSrDataListener(new OnReceivedRtcpSrDataListener() {
                @Override
                public void onReceivedRtcpSrData(IMediaPlayer mp, byte[] data) {
                    finalListener.onReceivedRtcpSrData(MediaPlayerProxy.this, data);
                }
            });
        } else {
            mBackEndMediaPlayer.setOnReceivedRtcpSrDataListener(null);
        }
    }

    @Override
    public void setOnTookPictureListener(OnTookPictureListener listener) {
        if (listener != null) {
            final OnTookPictureListener finalListener = listener;
            mBackEndMediaPlayer.setOnTookPictureListener(new OnTookPictureListener() {
                @Override
                public void onTookPicture(IMediaPlayer mp, int resultCode, String fileName) {
                    finalListener.onTookPicture(MediaPlayerProxy.this, resultCode, fileName);
                }
            });
        } else {
            mBackEndMediaPlayer.setOnTookPictureListener(null);
        }
    }
    ...
    public void setOnRecordVideoListener(OnRecordVideoListener listener) {
        if (listener != null) {
            final OnRecordVideoListener finalListener = listener;
            mBackEndMediaPlayer.setOnRecordVideoListener(new OnRecordVideoListener() {
                @Override
                public void onRecordVideo(IMediaPlayer mp, int resultCode, String fileName) {
                    finalListener.onRecordVideo(MediaPlayerProxy.this, resultCode, fileName);
                }
            });
        } else {
            mBackEndMediaPlayer.setOnRecordVideoListener(null);
        }
    }
    ...
    public void setOnDeviceConnectedListener(OnDeviceConnectedListener listener) {
        if (listener != null) {
            final OnDeviceConnectedListener finalListener = listener;
            mBackEndMediaPlayer.setOnDeviceConnectedListener(new OnDeviceConnectedListener() {
                @Override
                public void onDeviceConnected(IMediaPlayer mp) {
                    finalListener.onDeviceConnected(MediaPlayerProxy.this);
                }
            });
        } else {
            mBackEndMediaPlayer.setOnDeviceConnectedListener(null);
        }
    }
